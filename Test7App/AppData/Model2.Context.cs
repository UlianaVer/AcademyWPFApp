...
namespace Test7App.AppData
{
    ...
    public partial class StudentsDB1Entities1 : DbContext
    {
        public StudentsDB1Entities1()
            : base("name=StudentsDB1Entities1")
        {
        }
        ...
        public virtual DbSet<HistoryStudent> HistoryStudent { get; set; }
        public virtual DbSet<Journal1> Journal1 { get; set; }
